...
import UnifiedStartupScreen from "./UnifiedStartupScreen";
...
export default function Welcome({
  ...
  if (isCheckingAuth) {
    return <UnifiedStartupScreen statusText="Checking authentication..." />;
  }

  if (isCreating) {
    return <UnifiedStartupScreen statusText="Setting up your session..." />;
  }
            ...
            <div className="w-full max-w-xs">
              <form className={cn("flex flex-col gap-6")}>
                <div className="flex flex-col items-center gap-2 text-center">
                  <h1 className="text-2xl font-bold">Sign in to RogueGrid</h1>
                  <p className="text-balance text-sm text-muted-foreground">
                    Authenticate with your provider to get started
                  </p>
                </div>
                ...
                {waitingForOAuth && !showUsernameStep ? (
                  ...
                  <div className="space-y-5">
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Pick a handle so teammates can find you
                      </p>
                    </div>
        ...
        <div className="relative hidden bg-muted lg:block">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="max-w-md space-y-4 text-center">
              <Radar className="mx-auto h-24 w-24 text-primary/80" />
              <h2 className="text-3xl font-bold">Welcome to RogueGrid</h2>
              <p className="text-muted-foreground">
                Launch purpose-built grids, share processes, and collaborate instantly over a secure peer graph.
              </p>
            </div>
          </div>
        </div>
